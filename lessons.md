...
- [seed][global] Agent calls can't specify effort; effort only lives in the agent definition's frontmatter (low/medium/high/xhigh) → roles needing a specific effort need a ~/.claude/agents/ definition first → applied to: delegate-work
